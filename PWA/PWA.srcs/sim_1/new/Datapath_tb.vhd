...
architecture testbench of Datapath_tb is
    ...
    signal FS3, FS2, FS1, FS0 : STD_LOGIC := '0';
    ...
    procedure apply_control (
        ...
        signal s_FS3 : out STD_LOGIC;
        signal s_FS2 : out STD_LOGIC;
        signal s_FS1 : out STD_LOGIC;
        signal s_FS0 : out STD_LOGIC;
...
begin
    ...
    begin
        ...
        -- Load R0 = 0x0A
        apply_control(RW, DA, AA, BA, MB, ConstantIn, FS3, FS2, FS1, FS0, Cin, DataIn, MD,
